...
{
    public static readonly StringName GDExtensionName = "FmodEventEmitter3D";
    ...
    /// <summary>
    /// Creates an instance of the GDExtension <see cref="FmodEventEmitter3D"/> type, and attaches the wrapper script to it.
    /// </summary>
    /// <returns>The wrapper instance linked to the underlying GDExtension type.</returns>
    public static FmodEventEmitter3D Instantiate()
    {
        return GDExtensionHelper.Instantiate<FmodEventEmitter3D>(GDExtensionName);
    }

    /// <summary>
    /// Try to cast the script on the supplied <paramref name="godotObject"/> to the <see cref="FmodEventEmitter3D"/> wrapper type,
    /// if no script has attached to the type, or the script attached to the type does not inherit the <see cref="FmodEventEmitter3D"/> wrapper type,
    /// a new instance of the <see cref="FmodEventEmitter3D"/> wrapper script will get attaches to the <paramref name="godotObject"/>.
    /// </summary>
    /// <remarks>The developer should only supply the <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</remarks>
    /// <param name="godotObject">The <paramref name="godotObject"/> that represents the correct underlying GDExtension type.</param>
    /// <returns>The existing or a new instance of the <see cref="FmodEventEmitter3D"/> wrapper script attached to the supplied <paramref name="godotObject"/>.</returns>
    public static FmodEventEmitter3D Bind(GodotObject godotObject)
    {
        return GDExtensionHelper.Bind<FmodEventEmitter3D>(godotObject);
    }
#region Properties
