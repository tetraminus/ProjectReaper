...
{
    [Export]
    public Node NextState { get; set; }
    public override void OnEnter(object[] args)
    {
        GameManager.PlayerHud.Connect(PlayerHud.SignalName.FightAnimFinished, Callable.From(OnFightAnimFinished), (uint)ConnectFlags.OneShot);
